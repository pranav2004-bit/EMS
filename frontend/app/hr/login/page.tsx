...
export default function HRLoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await api.post('/hr/login', { email, password });
            login(email, 'hr');
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-navy-900 relative">
            ...
            <div className="card w-full max-w-md relative">
                ...
                <h1 className="text-2xl font-bold text-center mb-2">HR Investigator Login</h1>
                <p className="text-muted-gray text-center mb-8">Access the ethical risk management system</p>
